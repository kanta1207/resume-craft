            ...
            <div className="lg:col-span-2 space-y-10">
              <section>
                ...
                <div className="prose prose-zinc max-w-none text-muted-foreground leading-relaxed text-sm">
                  <p>{job.description}</p>
                  <p className="mt-4">
                    We're looking for an exceptional engineer to join our growing team and help shape
                    the future of our product. You'll work on challenging problems at scale, collaborate
                    with talented engineers, and have the opportunity to make a significant impact on
                    our platform.
                  </p>
                </div>
              </section>
