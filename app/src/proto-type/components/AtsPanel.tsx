    ...
    <div className="p-6 space-y-8 bg-background">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          ...
          <div className="text-[10px] text-emerald-600 font-medium uppercase tracking-wide">Excellent</div>
        </div>
      </div>
      ...
      <div className="relative group overflow-hidden rounded-xl border border-primary/20 bg-primary/5 p-5">
        ...
        <div className="relative space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="secondary" className="bg-background/50 backdrop-blur-sm text-primary shadow-none">
              High Priority
            </Badge>
          </div>
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Your resume demonstrates strong alignment with the job requirements. Focus on adding quantifiable metrics to increase impact.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-3 rounded-xl border border-border/50 bg-card p-4 hover:bg-muted/20 transition-colors">
          ...
          <div>
            <div className="text-xl font-semibold text-foreground">{analysis.matchedKeywords}/{analysis.totalKeywords}</div>
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          <h4 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Keyword Analysis</h4>
          
          <div className="rounded-xl border border-border/50 bg-card p-4 space-y-4">
            <div>
              <span className="text-xs font-medium text-muted-foreground mb-2 block">Found in Resume</span>
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Structure Analysis</h4>
        ...
        <div className="rounded-xl bg-amber-500/5 border border-amber-500/10 p-4">
          ...
          <ul className="space-y-2.5">
            <li className="flex gap-2.5 text-xs text-muted-foreground">
              ...
              <span>Add more quantifiable achievements with specific metrics (e.g., "Increased revenue by 20%")</span>
            </li>
            <li className="flex gap-2.5 text-xs text-muted-foreground">
              <span className="text-amber-500 mt-0.5">•</span>
