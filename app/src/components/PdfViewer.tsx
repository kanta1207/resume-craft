			...
			<div className="flex-1 overflow-auto p-8 pt-20 flex items-start justify-center">
				<div
					...
					style={{
						...
						boxShadow:
							"0 0 0 1px rgba(0,0,0,0.03), 0 8px 40px -8px rgba(0,0,0,0.08), 0 20px 60px -12px rgba(0,0,0,0.08)",
					}}
				>
					...
					<div className="p-12 text-gray-900 h-full font-sans">
						...
						<div className="mb-8">
							<h2 className="text-xs font-bold mb-3 text-gray-500 tracking-widest uppercase">
								Professional Summary
							</h2>
							<p className="text-sm text-gray-800 leading-relaxed">
								Results-driven Senior Frontend Engineer with 7+ years of
								experience building scalable web applications using React,
								TypeScript, and modern JavaScript frameworks. Proven track
								record of optimizing performance, leading technical initiatives,
						...
						<div className="mb-8">
							...
							<div className="text-sm text-gray-800 grid grid-cols-1 gap-2">
								<div className="flex">
									<span className="font-semibold w-32 flex-shrink-0">
										Languages
									</span>
						...
						{/* Experience */}
						<div className="mb-8">
							<h2 className="text-xs font-bold mb-4 text-gray-500 tracking-widest uppercase">
								Experience
							</h2>
							...
							<div className="mb-6 relative pl-4 border-l-2 border-gray-100">
								...
								<ul className="text-sm text-gray-700 space-y-2 list-disc list-inside marker:text-gray-300">
									<li>
										Architected and implemented responsive React components
										serving 2M+ users
									</li>
									<li>
										Reduced bundle size by 40% through code-splitting and lazy
										loading strategies
									</li>
									<li>
										Led migration from JavaScript to TypeScript, improving code
										maintainability
									</li>
									<li>
										Mentored 5 junior developers and conducted regular code
										reviews
									</li>
								</ul>
							</div>
							...
							<div className="mb-6 relative pl-4 border-l-2 border-gray-100">
								...
								<ul className="text-sm text-gray-700 space-y-2 list-disc list-inside marker:text-gray-300">
									<li>
										Developed customer-facing dashboard using React and Redux
									</li>
									<li>Improved Lighthouse performance score from 65 to 95</li>
									<li>
										Implemented comprehensive unit and integration tests (90%
										coverage)
									</li>
								</ul>
							</div>
