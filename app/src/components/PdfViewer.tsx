          ...
          <div className="p-12 text-gray-900 h-full font-sans">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-800 leading-relaxed">
                Results-driven Senior Frontend Engineer with 7+ years of experience building scalable
                web applications using React, TypeScript, and modern JavaScript frameworks. Proven track
                record of optimizing performance, leading technical initiatives, and mentoring junior
                developers.
              </p>
            </div>
